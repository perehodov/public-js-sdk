 ...
 */
export const BASE_FEE = 50000; // peanuts
 ...
 * @param {number} opts.fee - The max fee willing to pay per operation in this transaction (**in peanuts**). Required.
...
export class TransactionBuilder {
  constructor(sourceAccount, opts = {}) {
    ...
    if (isUndefined(opts.fee)) {
      throw new Error('must specify fee for the transaction (in peanuts)');
    }
  ...
  build() {
    ...
    const sequenceNumber = new BigNumber(this.source.sequence).add(1);
